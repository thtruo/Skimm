...
/* Define the route controller for the postsList route
 */
PostsListController = RouteController.extend({
  ...
  data: function() {
    ...
    // postsList route builds its own path using the JS object as data context
...
/* Least specific route that matches the root plus pagination limit parameter
 */
